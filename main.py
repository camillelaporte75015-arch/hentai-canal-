...
# --- LISTES & DICT ---
blacklist = {OWNER_ID}  # seuls les users dans la blacklist peuvent utiliser les commandes
...
# --- RUN CLIENT ---
async def main():
    await client.start()  # te demandera ton numéro + code la première fois
